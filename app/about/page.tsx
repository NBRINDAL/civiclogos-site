...
export const metadata: Metadata = {
  title: "About Civic Logos | Civic Logos",
  description:
    "Read the longer public narrative, manifesto, and distinctions behind Civic Logos while the main interaction surface lives in the chat workspace.",
};
    ...
    <div className={styles.page}>
      ...
      <header className={styles.hero} id="top">
        <nav className={styles.nav}>
          <SiteBrand className={styles.brand} href="/" subtitle="About Civic Logos" />
        ...
        <div className={styles.heroGrid}>
          <div className={styles.heroCopy}>
            ...
            <div className={styles.heroActions}>
              ...
              <Link className={styles.secondaryAction} href="/healthcare">
